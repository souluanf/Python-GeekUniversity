...
def cumprimentar_v7(*, nome, mensagem):
    print(f"Meu nome é {nome} e minha frase favorita do dia é: '{mensagem}'.")


cumprimentar_v7(nome='Luan', mensagem='Sem música, a vida seria um erro')
