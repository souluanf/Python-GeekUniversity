...
um atributo privado chamadp __nome e um método privado chamado __falar()
...
acessar elemento privados, conforme:

_Classe__elemento

Exemplo - Acessando elemento privados fora da classe:

instancia._Pesssoa__nome
instancia._Pesssoa__falar()
...
conta1._Conta__titular = 'Luan Fernandes'
...
conta2 = Conta('Fernandes', 300.00, 2000)
conta2.extrato()
